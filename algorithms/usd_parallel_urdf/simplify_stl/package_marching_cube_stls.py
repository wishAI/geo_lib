...
def main() -> None:
    ...
    for stl_path in stl_paths:
        ...
        basis = None
        axis_local = None
        axis_mode = mesh_policy.marching_axis_mode
        if link_name in record_by_name:
            axis_local, axis_mode = _resolve_marching_axis_local(
                record_by_name[link_name],
                record_by_name,
                mesh_policy,
            )
        ...
        stats['marching_axis_mode'] = axis_mode
        stats['resolved_mesh_policy'] = mesh_policy.__dict__
